...
class Morphing2DtestPatch : public Patch {
	VoltsPerOctave hz;
private:
  OscSelector *morph1;
  OscSelector *morph2;
...
public:
  Morphing2DtestPatch() {																		
    float* bankset1[NOF_OSC] = { bank_4106[0], wavetrip6[0], synth_vo6[0], alien_sp6[0], additive6[0]};		//, amen_loo6[0] 														
...
;  }
  void processAudio(AudioBuffer &buffer) {
    ...
    morph2->setFrequency(1.16*freqA/sampleRate);
    morph2->setMorphX(1.0-morphC);
